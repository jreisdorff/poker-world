...
function Index() {
  ...
  (0, import_react10.useEffect)(() => {
    ...
    socket.on("confirmation", (data) => {
      ...
      window.speechSynthesis.speak(msg), setChat((prevChats) => [...prevChats, newChat]);
