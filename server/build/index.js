...
var tailwind_default = "/build/_assets/tailwind-254RRVF7.css";
...
function Index() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("main", {
    ...
    className: "fixed bottom-0 left-0 h-[75px] w-[225px] overflow-scroll rounded-tr-xl bg-black/80 text-white"
  }, /* @__PURE__ */ React.createElement("div", {
    ...
    className: `mb-8 w-full items-center justify-center self-center text-center text-3xl text-white transition-all duration-[1000ms] ${winner ? "opacity-100" : "opacity-0"}`
