...
var tailwind_default = "/build/_assets/tailwind-OUD4VIAD.css";
...
var cards_default = "/build/_assets/cards-APV7OJEA.css";
...
function Index() {
  ...
  (0, import_react8.useEffect)(() => {
    ...
    socket.on("confirmation", (data) => {
      ...
      setGameState(data.gameState), setGameStarted(data.gameStarted), setGameOver(data.gameOver), setDealtCards(data.dealtCards), setDealerCards(data.dealerCards), setPlayers(data.players), setPots(data.pots), setUltimateWinner(null), setWinningCards([]), setActiveBet(bigBlindAmount), setDealer(data.dealer), setLittleBlind(data.littleBlind), setBigBlind(data.bigBlind), setActivePlayerIndex(data.dealerIndex), setActivePlayer(data.players[data.dealerIndex]);
